...
public class ConexionMySQL {
    ...
    public void ConectarBasedeDatos() {
        try {
            ...
            final String url_bd = "jdbc:mysql://localhost:3307/bdasignacion";
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Si olvido contraseña ingrese ");
    ...
    try {
         ...
         String u = grupo6.getText();
         String p = UMG2022.*.getText();
         Con.ConectarBasedeDatos();
               
         String SQL = "SELECT id, user_name From usuarios" 
                 + "WHERE username='"+u+"' AND user_pass='"+p+"'";
