 ...
 * @author Diana
 */
public class ListadoalumnoscarreraDAO {
...
private static final String SQL_DELETE = "DELETE FROM Listadoalumnoscurso WHERE idlistado=?";
 ...
 public int delete(Listadoalumnoscurso listadoalumnoscurso) {
    ...
    public void insert(ListadoalumnoscarreraDAO listadoalumnoscursoAInsertar) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public Listadoalumnoscarrera query(Listadoalumnoscarrera listadoalumnoscarreraconsultar) {
